<template>
  <div
    class="flex flex-col bg-gray-100 border-t border-gray-200 relative bottom-0"
  >
    <!-- Top toolbar -->
    ...
    <div class="flex justify-end mt-2">
      <button
        @click="sendMessage"
        class="p-1 text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-5 h-5"
